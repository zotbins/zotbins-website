  ...
  return (
    <div className="pt-12 m-8">
      <div className="text-black/80 text-left py-4">
        <h2 className="text-4xl font-bold text-[#87b676] animate__animated animate__fadeInUp">The ZotBin</h2>
      ...
      <div className="flex flex-col items-center justify-center py-4">
        ...
        <div className="mt-2 text-sm text-center text-gray-500 dark:text-gray-400 relative rounded-lg ">
      ...
      <div className="text-black/80 text-left py-4">
        <h2 className="text-4xl font-bold text-[#87b676] animate__animated animate__fadeInUp">The ZotZero App</h2>
        <h3 className="text-xl mt-4 animate__animated animate__fadeInUp">
