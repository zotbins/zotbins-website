      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        ...
        <div className="text-center mb-16 animate__animated animate__fadeIn">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto animate__animated animate__fadeInUp animate__delay-1s">
            Revolutionizing waste management through smart technology and
            machine learning
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                We are currently researching ways to leverage new machine
                learning models to interactively segment and classify trash to
                assist in proper sorting. With our findings, we are constructing
                a physical smart waste bin that will guide users towards proper
                waste handling, called the ZotBin!
              </p>
            </div>
        ...
        <div className="bg-[#e9f7e4] rounded-2xl shadow-xl p-8 md:p-12 mb-16 animate__animated animate__fadeInUp">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 order-1 md:order-2">
              <h2 className="text-4xl font-bold text-[#87b676]">
                The ZotZero App
              </h2>
              <p className="text-xl text-gray-600 leading-relaxed">
                To facilitate the hardware, we are developing a mobile
                application that will allow users to capture photos of their
                food waste, which will be sent to the machine learning model and
                then communicate to the users the correct bin for disposal.
              </p>
        ...
        <div className="bg-[#e9f7e4] rounded-2xl shadow-xl p-8 md:p-12 animate__animated animate__fadeInUp">
          <h2 className="text-4xl font-bold text-[#87b676] mb-8 text-center">
            Interactive Demo
          </h2>
